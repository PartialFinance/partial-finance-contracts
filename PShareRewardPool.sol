...
contract PShareRewardPool is ReentrancyGuard{
    ...
    uint256 public constant pSharePerSecond = 0.0014373748748749 ether; // 45950 pshare / (370 days * 24h * 60min * 60s)
    uint256 public constant runningTime = 370 days; // 370 days
    uint256 public constant TOTAL_REWARDS = 45950 ether;
