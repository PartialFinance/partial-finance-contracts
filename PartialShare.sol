...
contract PartialShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 55,000 PSHAREs
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 45950 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Partial Share", "PSHARE") {
        _mint(msg.sender, 50 ether); // mint 50 Partial Share for initial pools deployment
